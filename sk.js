...
const loadMicrosoft = () => {
    ...
    workInfo.innerHTML = "<h3>Incoming SWE Intern @ Microsoft</h3><h4>May 2022 - Aug 2022</h4><p>> Will Intern at Microsoft during the Summer of 2022.</p>"
...
const loadDevStac = () => {
    const workInfo = document.querySelector("#workInfo")
    workInfo.innerHTML = "<h3>Software Engineer @ DevSTAC</h3><h4>Oct 2021 - Present</h4><p>> Developed Fund Kill, a web app that is currently being used in a real Washington University business course to teach students about investments and exit strategies.</p><p>> Utilized React Native to help develop a cross-platform mobile application currently being used at the Washington University Medical Center that assists doctors in detecting strokes in patients.</p>"
...
const loadCapitalOne = () => {
    const workInfo = document.querySelector("#workInfo")
    workInfo.innerHTML = "<h3>SWE Intern @ Capital One</h3><h4>Oct 2021 - Present</h4><p>> Built an HR operational dashboard using Vue.js and Django as part of the Enterprise, Data, and Machine Learning team at Capital One. The dashboard will be used by more than 200 HR employees.</p><p>> Developed a slack chat bot that will promote Diversity, Inclusion, and Belonging within Capital One's working culture.</p>"
...
window.onresize = () => {
    ...
    if(width < 900) {
        document.getElementsByClassName("navbar")[0].style.top = "0vh"
        document.getElementById("navButton").style.right = "2vw"
